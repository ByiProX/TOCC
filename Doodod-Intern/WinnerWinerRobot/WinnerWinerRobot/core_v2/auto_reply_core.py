...
def get_auto_reply_setting(user_info):
    ...
    for keywords_info in keywords_info_list:
        ...
        for reply_content in reply_content_list:
            ...
            message_json["source_url"] = reply_content.get("source_url")
            message_json["thumb_url"] = reply_content.get("thumb_url")
            message_json["title"] = reply_content.get("title")
            message_json["desc"] = reply_content.get("desc")
            ...
            message_json["create_time"] = reply_content.get("create_time")
...
def create_a_auto_reply_setting(user_info, chatroom_list, message_list, keyword_list, keywords_id = None):
    ...
    for i, message_info in enumerate(message_list):
        ...
        reply_content['seq'] = i
        reply_content["source_url"] = message_info.get("source_url")
        reply_content["thumb_url"] = message_info.get("thumb_url")
        reply_content["title"] = message_info.get("title")
        reply_content["desc"] = message_info.get("desc")
        ...
        reply_content["create_time"] = message_info.get("create_time")
